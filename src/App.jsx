...
export default function App() {
    ...
    return (
        <div className="relative min-h-[100dvh] w-full flex flex-col items-center justify-center p-4 sm:p-8 overflow-hidden bg-[#0a0f1e]">
            {/* BACKGROUND */}
            ...
            >
                ...
                <div className="mt-8 sm:mt-10 text-center text-white">
                    <p className="text-4xl sm:text-5xl font-extralight tracking-tighter flex items-baseline justify-center">
                        ...
                        <span className="text-xs sm:text-sm text-blue-300/40 ml-2 uppercase tracking-[0.2em] font-normal">
                            ml
                        </span>
                    </p>
                </div>
                    ...
                    >
                        <div className="glass w-full max-w-md p-7 rounded-[35px] border border-white/20 shadow-2xl">
                            <div className="flex justify-between items-center mb-5 text-white">
                                ...
                                <button onClick={() => setIsAdmin(false)} className="hover:rotate-90 transition-transform">
                                    <X size={20}/>
                                </button>
                            </div>
                            <textarea
